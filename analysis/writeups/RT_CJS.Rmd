...
In 2017-18 and 2018-19, we focused on tags that were released from the lower Lemhi rotary screw trap (code LLRTP). In 2019-20, we also included tags released from the upper Lemhi rotary screw trap (code LEMTRP). 
